...
import cn.szu.blankxiao.mycalendar.library.R
...
object NotificationHelper : KoinComponent {
    private val launcherActivityClass: Class<*> by inject(named("launcherActivity"))
    ...
    fun showReminderNotification(
        ...
        // 点击通知打开应用的Intent
        val intent = Intent(context, launcherActivityClass).apply {
